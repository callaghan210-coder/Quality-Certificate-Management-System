report 50100 "Vendor - Summary AgingExt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/ReportVendorSummaryAging.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Cutom Vendor - Summary Aging';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(Picture; CompanInformation.Picture)
            {
                AutoFormatType = 1;
            }
            column(Phone_No_; CompanInformation."Phone No.")
            {

            }
            column(Address; CompanInformation.Address)
            {
            }
    ...
    begin
        ...
        CompanInformation.get();
        CompanInformation.CalcFields(Picture);
        if CompanInformation.get(CompanInformation."Country/Region Code") then;

    end;

    var
        CompanInformation: Record "Company Information";
